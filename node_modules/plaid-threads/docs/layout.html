      ...
      <div class="container">
        <div class="page__content">
          <div class="grid">
            ...
            <div class="grid__column grid__column--is-nine-columns">
              <div class="documentation-article">
                <header class="documentation-article__header">
                  <h1 class="primary-heading">{{ title }}</h1>
                  <p class="secondary-heading secondary-heading--is-muted">{{ description }}</p>
                </header>
                {{{ contents }}}
              </div>
            </div>
