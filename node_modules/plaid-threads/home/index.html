...
<html>
  ...
  <body>
    <main class="page">
      <div class="home-body">
        <div class="home-container u-vertically-center">
          <span class="threads-brand threads-brand--is-verticle-lockup">
            <span class="threads-brand__logo"></span>
            <span class="threads-brand__logotype"></span>
          </span>
          <h2 class="secondary-heading light-color">A toolkit for rapidly prototyping web interfaces at Plaid, by Plaid</h2>
          <div>
            <a class="button button--is-primary button--is-bright button--has-margin-right" href="/install">View the docs</a>
            <a class="button button--is-default button--is-bright" href="https://github.plaid.com/plaid/threads">See it on Github</a>
          </div>
        </div>
      </div>
    </main>
